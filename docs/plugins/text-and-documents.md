...
Extracts structured ingredient and method data from HTML pages that use Schema.org Recipe markup. The result is structured metadata: ingredient list, yield, cook time, cuisine. Enables natural-language recipe search over a personal collection of saved pages.

## Inventory Scanning

**Stack:** `pyzbar` + vision model
