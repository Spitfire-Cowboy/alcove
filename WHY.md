...
*The word [alcove](https://en.wikipedia.org/wiki/Alcove_(architecture)) comes from Arabic* القبة *(al-qubbah) — "the vault" — via Spanish* alcoba. *An enclosed, protected space for things that matter. That is the product.*
